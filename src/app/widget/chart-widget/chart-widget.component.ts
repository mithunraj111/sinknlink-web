  ...
  ngOnInit() {
    setTimeout(() => {
      ...
      this.emailChartData = {
        datasets: [{
          data: [300, 170, 60],
          backgroundColor: ['#03ADED', '#2ed8b6', '#FF5370'],
          label: 'Dataset 1',
          borderWidth: 0
      ...
      x.addColorStop(1, '#03ADED');

      this.seoCard1Data = e('#2ed8b6', [100, 80, 100, 150, 190, 200, 160], cde);
      this.seoCard1Option = f();

      this.seoCard2Data = e('#03ADED', [100, 80, 100, 150, 190, 200, 160], x);
